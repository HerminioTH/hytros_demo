...
@callback(
    Output(component_id=gid("well_design", "impact-color", MATCH), component_property="style"),
    Input(component_id=gid("well_design", "impact", MATCH), component_property="value"),
)
